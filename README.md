...
[![Version](https://img.shields.io/badge/version-v4.0.0-blue.svg)](https://github.com/zhaosan2023/dotfiles-bmad-solo/releases/tag/v4.0.0)
...
当前仓库主线默认激活并维护 **V4** 版本，同时通过专用稳定分支与 Release Tags 对历史演进版本进行完整归档：

| 版本 | 状态 | 对应分支 | 对应 Tag | 核心特性说明 |
| :--- | :--- | :--- | :--- | :--- |
| **V4** | 🟢 **当前主力主版本 (Active)** | `main` / `v4-stable` | `v4.0.0` | **分析师闭环门禁 + 4 大收敛防死循环锁**<br>• `/bmad-solo`：全生命周期工程闭环（Analyst / Architect / Dev / Reviewer / QA / Operator）<br>• `/ana-solo`：独立深度分析通道（Keshav 三读法、决策选型矩阵、证据防火墙） |
